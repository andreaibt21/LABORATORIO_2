...
namespace Entidades
{
    public delegate void delegadoJuego(Object sender, short movimiento);
    ...
    public class Juego
    {
        ...
        public event delegadoJuego InformarAvance; 

        public void informarAvance()
        {
        ...
        public void IniciarCarrusel()
        {
            do
            {
                ...
                InformarAvance.Invoke(this, Avanzar());
