...
namespace View
{
    public partial class FrmView : Form
    {
      ...
      //      if (ExisteArchivo(archivoPath))
        ...
        private void picCarrousel_Click(object sender, EventArgs e)
        {
        ...
        {
         //   Juego.Velocidad = nudVelocidad.Value;
        }
    }
}
